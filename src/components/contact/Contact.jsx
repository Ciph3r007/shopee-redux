...
import profileTanveerSir from "../../assets/img/profile-tanveer-sir.webp";
import profileMasumBhai from "../../assets/img/profile-masum-bhai.jpg";
import profileAnikBhai from "../../assets/img/profile-anik-bhai.jpg";
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow px-8 py-4 pt-24">
            <div className="text-center">
              ...
              <p className="text-md text-gray-500 w-60 dark:text-gray-400 mx-auto py-4 font-light">
                A fantastic technical leader who holds the Agile principles at
                his core.
              </p>
            </div>
        ...
        <div className="p-4 relative transform sm:scale-100 md:scale-75 lg:scale-100">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow px-8 py-4 pt-24">
            <div className="text-center">
              ...
              <p className="text-md text-gray-500 w-60 dark:text-gray-400 mx-auto py-4 font-light">
                Mushraful is full of dedication, quality of work and excellent
